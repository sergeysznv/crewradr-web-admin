  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-dashed border-outline bg-surface p-lg">
        ...
        <h3 className="mt-3 text-base font-semibold text-on-surface">Webhooks not yet available</h3>
        <p className="mt-1 text-sm text-on-surface-variant">
          Webhook delivery is not enabled for this workspace yet. When it ships you will be
          able to register endpoints here and receive real-time events for:
        </p>
